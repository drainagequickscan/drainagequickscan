...
xsm_hd = pdd.HorizontalDrainXsec(
    pdd.XsecDikeModel(xdict, zdict, kdict, wdict), x_drn=0.0, drawdown=2.0
)
xsm_hd.solve()
...
ax.plot(
    ...
    hds[0],
    lw=2,
    label="stijghoogte 1$^e$ wvp zonder drainagesysteem",
    c="C3",
    ls="dashed",
)
ax.plot(
    ...
    hds_hd[0],
    lw=2,
    label="stijghoogte 1$^e$ wvp met horizontale drain",
    c="C3",
    ls="solid",
)
